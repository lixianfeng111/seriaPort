...
import java.util.Date;
 ...
 public class TestFunction {
    ...
    public static String[] testFunctionOrderedList = new String[]{
            ...
            "Test_Pos_PrintBarcode_Code128Auto",
    ...
    static void Test_Pos_SampleTicket_58MM_1(Activity activity,Pointer h) {
        int paperWidth = 384;
        ...
        {
            Test_Pos_QueryPrintResult(activity,h);
        }
    }

    static void Test_Pos_SampleTicket_58MM_2(Activity activity,Pointer h) {
    ...
    static void Test_Pos_SampleTicket_80MM_1(Activity activity,Pointer h) {
...

        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("xxxx公司\r\n"));
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 200);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("北京\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 0);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("机器号"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 200);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("GGG\r\n"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 0);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("用户"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 200);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("张三\r\n"));
//            int nStartPos = 0;
//            int nEndPos = 120;
...
//            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("麻辣香锅（上梅林店）\r\n2018年2月7日15:51:00\r\n\r\n"));
        }
        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("2017-09-09"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 100);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("11:09:32\r\n"));


            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 20);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("原钞袋ID"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 200);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("123\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 20);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("原钞袋ID"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 200);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("SSS123\r\n"));
...
//            AutoReplyPrint.INSTANCE.CP_Pos_SetPrintAreaLeftMargin(h, 0);
    ...
    public static void Test_Pos_SampleTicket_80MM_2(Activity activity, Pointer h) {
...

        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("2017-01-01"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 2900);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("18:09:23\r\n"));
        ...
        }
        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 240);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("3\r\n"));
        ...
        }
        {
            AutoReplyPrint.INSTANCE.CP_Pos_FeedLine(h, 1);
            AutoReplyPrint.INSTANCE.CP_Pos_SetTextBold(h, 1);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("硬币：CNA\r\n"));
        ...
        }
        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("3"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 300);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("3000\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("500"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 150);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("3"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 300);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("1500\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("100"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 150);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("3"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 300);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("300\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("50"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 150);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("3"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 300);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("150\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("20"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 150);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("4"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 300);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("80\r\n"));
...
//            AutoReplyPrint.INSTANCE.CP_Pos_FeedLine(h, 1);
        ...
        }
        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 100);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("CNY "+400+"\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 20);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("硬币"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 100);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("CNY "+3090+"\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 20);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("支票"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 100);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("CNY "+10000+"\r\n"));
        ...
        }
        {
            AutoReplyPrint.INSTANCE.CP_Pos_FeedLine(h, 1);
            AutoReplyPrint.INSTANCE.CP_Pos_SetTextBold(h, 1);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("币种：HKD\r\n"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetTextUnderline(h,200);
            AutoReplyPrint.INSTANCE.CP_Pos_FeedLine(h, 1);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("Banknote\r\n"));
...

        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("1000"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 240);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("100000\r\n"));
//            AutoReplyPrint.INSTANCE.CP_Pos_FeedLine(h, 1);
            AutoReplyPrint.INSTANCE.CP_Pos_SetTextUnderline(h,500);
        ...
        }
        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 10);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("HKD"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 100);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("HKD "+3090+"\r\n"));
    ...
    //存款报告打印
    public static void deposit_Print_SampleTicket(Activity activity, Pointer h){
        {
            AutoReplyPrint.INSTANCE.CP_Printer_ClearPrinterBuffer(h);
            AutoReplyPrint.INSTANCE.CP_Pos_ResetPrinter(h);
            AutoReplyPrint.INSTANCE.CP_Pos_SetMultiByteMode(h);
        ...
        }
        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("2020/12/10："));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 240);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("13:20:00\r\n"));
...
//            AutoReplyPrint.INSTANCE.CP_Pos_FeedLine(h, 1);
        ...
        }
        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("金额"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 100);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("CNY "+500+"\r\n"));

            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 22);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("备注"));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 100);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("reject\r\n"));
        ...
        }
        {
            ...
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("STC 总计："));
            AutoReplyPrint.INSTANCE.CP_Pos_SetHorizontalAbsolutePrintPosition(h, 150);
            AutoReplyPrint.INSTANCE.CP_Pos_PrintTextInUTF8(h, new WString("1000000"));
        }
        {
            AutoReplyPrint.INSTANCE.CP_Pos_FeedLine(h, 1);
            AutoReplyPrint.INSTANCE.CP_Pos_SetAlignment(h, AutoReplyPrint.CP_Pos_Alignment_HCenter);
    ...
    static void Test_Pos_QueryPrintResult(Activity activity,Pointer h) {
    ...
    void Test_Pos_PrintBarcode(Pointer h) {
        ...
        AutoReplyPrint.INSTANCE.CP_Pos_PrintBarcode(h, AutoReplyPrint.CP_Pos_BarcodeType_CODE128, "0000No.1234567");
    ...
    void Test_Pos_PrintBarcode_Code128Auto(Pointer h) {
        AutoReplyPrint.INSTANCE.CP_Pos_SetBarcodeUnitWidth(h, 2);
        AutoReplyPrint.INSTANCE.CP_Pos_SetBarcodeHeight(h, 60);
        AutoReplyPrint.INSTANCE.CP_Pos_SetBarcodeReadableTextFontType(h, 0);
        AutoReplyPrint.INSTANCE.CP_Pos_SetBarcodeReadableTextPosition(h, AutoReplyPrint.CP_Pos_BarcodeTextPrintPosition_BelowBarcode);
        AutoReplyPrint.INSTANCE.CP_Pos_PrintBarcode_Code128Auto(h, "0000No.1234567");
    ...
    static void Test_Pos_PrintQRCodeUseEpsonCmd(Activity activity,Pointer h) {
    ...
    void Test_Pos_PrintRasterImageFromBitmap(Pointer h) {
        ...
        bitmap = TestUtils.scaleImageToWidth(bitmap, 384);
    ...
    static void Test_Page_SampleTicket_80MM_1(Activity activity,Pointer h)
    {
