 ...
 * 传感器状态
 */
public class SenserStatusFragment extends BaseFragment implements BaseRecyclerAdapter.Delegate {
    ...
    public int getFragmentViewById() {
        return R.layout.fragment_senser_status;
    }
    ...
    public int getView(ViewGroup parent, int viewType) {
        return R.layout.item_senser_status;
    }
