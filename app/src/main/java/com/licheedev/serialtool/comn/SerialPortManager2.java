...
public class SerialPortManager2 {
    ...
    private SerialReadThread2 mReadThread2;
    ...
    public void sendSaveCommand() {
        SerialPortManager2.instance().sendCommand(byteArrayToHexString(commandSave));
    }

    public void sendSaveAck() {
        SerialPortManager2.instance().sendCommand(byteArrayToHexString(commandSaveAck));
    }

    public void sendClearError() {
        SerialPortManager2.instance().sendCommand(byteArrayToHexString(commandClearError));
    }

    public void sendSDcardAck() {
        SerialPortManager2.instance().sendCommand(byteArrayToHexString(commandSDcardACK));
    }
    ...
    public void sendLeadCommand() {
        ...
        SerialPortManager2.instance().open(mDevice);
        SerialPortManager2.instance().sendCommand("A1A2A3A4040033BBBB33");
    }
...
//        SerialPortManager.instance().sendCommand(byteArrayToHexString(commandExit));
    ...
    public void closeMaskDoor() {
        SerialPortManager2.instance().sendCommand(byteArrayToHexString(commandMaskClose));
    }


    public void openMaskDoor() {
        SerialPortManager2.instance().sendCommand(byteArrayToHexString(commandMaskOpen));
    }
    ...
    private static class InstanceHolder {
        public static SerialPortManager2 sManager = new SerialPortManager2();
    }

    public static SerialPortManager2 instance() {
        return InstanceHolder.sManager;
    }

    private SerialPort mSerialPort;

    private SerialPortManager2() {
    ...
    public SerialPort open(String devicePath, String baudrateString) {
        ...
        try {
            ...
            mReadThread2 = new SerialReadThread2(mSerialPort.getInputStream());
            mReadThread2.start();
